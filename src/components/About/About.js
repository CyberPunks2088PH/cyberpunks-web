    ...
    return (
        <section id="lore">
            <div className="container">
                ...
                <p className="lore-sub lore-supply text-color-2 font-size-230 mb-0">And so, the story begins...</p>
            </div>
