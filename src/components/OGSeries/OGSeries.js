            ...
            <div className="container">
                <div className="series-k9-wrap mb-5">
                    ...
                    <div className="series-wrap">
                        ...
                        <p className="series-sub series-supply text-color-2 text-center font-size-210 font-size-sm-250 mb-0">Supply Count: 2,088 K9s</p>
                        <p className="series-sub series-supply text-color-2 text-center font-size-210 font-size-sm-250 mb-4">MINTING SOON</p>
                    </div>
